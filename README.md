...
1. **Creating a device**  
   ...
   > Note: If you're using a Raspberry Pi 3, it won't be powerful enough to be able to compile the .yaml needed to configure the ESP32. You'll need to compile it in your own machine for it to work. A more in-depth tutorial can be found [here.](./tutorials/CompilingESPHome.md)
